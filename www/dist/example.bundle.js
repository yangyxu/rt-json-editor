...
var ItemToolBar = __webpack_require__(3);
...
var ObjectAddItem = __webpack_require__(6);
...
var _array = React.createClass({
  ...
  render: function render() {
    ...
    var FIELDS = {
      ...
      "function": __webpack_require__(4),
      string: __webpack_require__(0),
      "boolean": __webpack_require__(0),
      date: __webpack_require__(0),
      number: __webpack_require__(0)
    };
    var _btns = [{
      icon: 'fa-plus',
      onClick: function onClick() {
...
var CodeMirror = __webpack_require__(20).UnControlled; //console.log(codemirror2);
...
var JSONEditor = __webpack_require__(29);

ReactDOM.render(React.createElement(JSONEditor, null), document.getElementById('container'));
...
React.createClass = __webpack_require__(31);

var Kind = __webpack_require__(36);
...
module.exports = React.createClass({
  ...
  __getKindInitSchemaByJSONPath: function __getKindInitSchemaByJSONPath(target, kind) {
  ...
  __onCreateKind: function __onCreateKind(kind) {
  ...
  render: function render() {
    ...
    return React.createElement("div", {
      ...
      className: "editor-warp"
    }, React.createElement("div", {
      className: "editor-header"
    }, React.createElement("div", {
      className: "title"
    }, "K8S YAML File Builder"), React.createElement("ul", {
      className: "tool-bar btns"
    }, React.createElement("li", {
      className: "btn",
      onClick: function onClick() {
        return _this.__onCreateKind('Deployment');
      }
    }, "Create Kind"))), React.createElement("div", {
      className: "editor-body"
    }, !!this.state.kinds.length ? React.createElement("ul", {
      className: "kinds"
      ...
      className: "note"
    }, "You first need to create kind block.")))));
  }
});
...
var FIELDS = __webpack_require__(8);
...
module.exports = React.createClass({
  ...
  __onChange: function __onChange(data, changedItem, root) {
...
var schema = {
  "basic": __webpack_require__(39),
  "Deployment": __webpack_require__(25),
  "devnet.platform": __webpack_require__(40)
};
